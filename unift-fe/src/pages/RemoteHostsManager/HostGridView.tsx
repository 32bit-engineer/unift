  ...
  if (hosts.length === 0) {
    return (
      <div className="col-span-full flex flex-col items-center justify-center py-20 gap-4 opacity-50">
        <span className="material-symbols-outlined text-5xl text-slate-500">lan</span>
          ...
          >
            ...
            <div className="p-4 flex flex-col gap-4 flex-1">
              ...
              <div className="flex items-center gap-1.5 mt-auto">
                ...
                <span className="text-[11px] font-mono text-slate-600">{host.lastConnected}</span>
              </div>
            </div>
            ...
            >
              ...
              <button
                ...
                title="Disconnect"
              >
                <span className="material-symbols-outlined" style={{ fontSize: '14px', color: '#5a6380' }}>
                  close
                </span>
              </button>
            </div>
