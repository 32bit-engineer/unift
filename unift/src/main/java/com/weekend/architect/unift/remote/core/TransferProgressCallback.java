...
/**
 * Functional callback invoked by the connection layer as bytes are transferred. The service layer
 * provides a lambda that updates the {@code TransferRegistry}.
 */
@FunctionalInterface
