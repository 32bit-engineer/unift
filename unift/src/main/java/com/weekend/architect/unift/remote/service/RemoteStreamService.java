 ...
 *
 * <p>This service is intentionally separate from {@link RemoteConnectionService}. The controller
 * bridges the returned {@link InputStream} to a Spring MVC {@link
 * org.springframework.web.servlet.mvc.method.annotation.StreamingResponseBody} so bytes are written
 * chunk-by-chunk directly to the HTTP response without buffering the full file in memory.
 */
public interface RemoteStreamService {
     ...
     *
     * <p>The caller is responsible for closing the stream. The connection itself is <em>not</em>
     * closed — it remains alive for subsequent operations.
     *
