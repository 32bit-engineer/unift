...
/**
 * Root unchecked exception for all remote-connection failures.
 * All sub-exceptions in this package extend this class so that a
 * single {@code @ExceptionHandler} can act as a fallback.
 */
