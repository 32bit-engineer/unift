 ...
 *
 * <p>Both methods use raw {@link InputStream} so that the connection layer
 * stays decoupled from Spring types ({@code MultipartFile},
 * {@code StreamingResponseBody}).  The service layer wraps these streams
...
public interface FileTransferable {
     ...
     *
     * <p>The caller <strong>must</strong> close the returned {@link InputStream}
     * when done to release the underlying channel resources.
     *
