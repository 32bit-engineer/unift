...
import com.weekend.architect.unift.auth.config.CorsConfig;
import com.weekend.architect.unift.common.filter.RateLimitFilter;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        http.cors(cors -> cors.configurationSource(corsConfigurationSource()))
                ...
                .authorizeHttpRequests(auth -> auth.dispatcherTypeMatchers(DispatcherType.ASYNC)
                        ...
                        .permitAll()
                        .requestMatchers("/ws/terminal/**")
                        .permitAll()
                        .requestMatchers("/api/ws/terminal/**")
                        .permitAll()
