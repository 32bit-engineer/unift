 ...
 * {@code unift.cache.terminal-session.*}.
 * Injected into {@code TerminalSessionRegistry} by concrete-class type matching.
 *
 * <h6>Redis migration</h6>
 * <p>Pass a {@code RedisRegistryCache<String, TerminalSession>} as the delegate in
 * {@link RegistryCacheConfig#terminalSessionCache()}.
 */
