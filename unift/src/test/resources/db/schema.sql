-- ============================================================
-- UniFT integration-test schema -- applied to the Testcontainers
-- PostgreSQL instance at context start-up via spring.sql.init.
--
-- Mirrors src/main/resources/db/migration/V1__initial_schema.sql
-- + V2__transfer_log_session_fields.sql.
-- Keep in sync with every production Flyway migration.
-- ============================================================
...
-- V1 columns + V2 additions: session_id and username
-- (mirrors V2__transfer_log_session_fields.sql applied on top of V1)
